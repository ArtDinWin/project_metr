                ...
                <form class="modal__form">
                    <div class="modal__form-content">
                        ...
                        <div class="formgroup formgroup--checkbox">
                            ...
                            <label class="policy-text" for="policy">Я согласен на обработку моих персональных
...
export function getInput() {
  const formData = {};
  formData.name_my = document.querySelector("#form-name").value;
  formData.phone_my = document.querySelector("#form-phone").value;
  return formData;
}
...
export function toggleFavoriteButton(isFaved) {
  ...
  if (isFaved) {
    ...
    btn.querySelector("span").textContent = "Добавить в избранное";
  }
}
